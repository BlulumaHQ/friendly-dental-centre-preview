...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "faq.q1": { en: "Are you accepting new patients?", zh: "你們接受新患者嗎？" },
  "faq.a1": { en: "Yes! We welcome new patients of all ages.", zh: "歡迎！我們接受各年齡層的新患者。" },
  "faq.q2": { en: "Do you accept CDCP (Canadian Dental Care Plan)?", zh: "你們接受 CDCP（加拿大牙科保健計劃）嗎？" },
  "faq.a2": { en: "Yes, we accept CDCP patients.", zh: "是的，我們接受 CDCP 患者。" },
  "faq.q3": { en: "Do you direct bill insurance?", zh: "你們提供保險直接申報嗎？" },
  "faq.a3": { en: "Yes, we offer direct billing to many insurance providers.", zh: "是的，我們可向多家保險公司直接申報。" },
  "faq.q4": { en: "Is parking available?", zh: "有提供停車嗎？" },
  "faq.a4": { en: "Paid underground Indigo parking is available nearby.\n\nAdditional parking may also be available at Richmond Curling Centre and nearby street parking depending on availability.", zh: "附近設有 Indigo 地下付費停車場。\n\n視乎情況，Richmond Curling Centre 及附近街邊亦可能有停車位。" },
  "faq.q5": { en: "How can I book an appointment?", zh: "如何預約？" },
  "faq.a5": { en: "Hygiene appointments are currently available through online booking on our website.\n\nFor all other appointment types, please submit an online appointment request or call our office directly.", zh: "洗牙預約目前可透過本網站線上預約。\n\n其他類型的預約請提交線上預約申請或直接致電診所。" },
